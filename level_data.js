...
levels = [
  ...
  { level: 10, theme: 'To Learn', orient: 0, size: { cols: 7, rows: 9 }, overlap: false, words: ["library", "museum", "school", "zoo"] },
  { level: 11, theme: 'Have Fun', orient: 0, size: { cols: 7, rows: 9 }, overlap: false, words: ["beach", "nightclub", "park", "pool"] },
  { level: 12, theme: 'Serious Face', orient: 0, size: { cols: 7, rows: 9 }, overlap: false, words: ["cemetery", "church", "court", "funeral"] },
  { level: 13, theme: 'Work, Work, Work', orient: 0, size: { cols: 7, rows: 9 }, overlap: false, words: ["diner", "home", "office", "shop", "store"] },
  { level: 14, theme: 'To Live', orient: 0, size: { cols: 7, rows: 9 }, overlap: false, words: ["apartment", "house", "hut", "mansion", "tent", "trailer"] }
];
